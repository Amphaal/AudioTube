...
class VideoInfos : public NetworkHelper {
    ...
    public:
        static promise::Defer fillStreamsManifest(const VideoMetadata::Id &videoId, const PlayerConfig &playerConfig, StreamsManifest &manifest);
    
    private:
        static promise::Defer _downloadRaw_VideoInfos(const VideoMetadata::Id &videoId, const QString &sts);
